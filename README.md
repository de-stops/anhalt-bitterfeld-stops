# anhalt-bitterfeld-stops

This is a simple script to download all Anhalt-Bitterfeld stops as [GTFS-compatible CSV](https://developers.google.com/transit/gtfs/reference/stops-file).
